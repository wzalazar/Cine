...
(function ($) {
	...
	$.wysiwyg.controls.table = function (Wysiwyg) {
		...
		formTableHtml = '<form class="wysiwyg" id="wysiwyg-tableInsert"><fieldset>' +
			'<p><label>{cols}: </label> <input type="text" name="colCount" value="3" style="width: 100px;" /></p>' +
			'<p><label>{rows}: </label> <input type="text" name="rowCount" value="3" style="width: 100px" /></label></p>' +
			'<br /><p><input type="submit" class="button submit" value="{submit}"/> ' +
			'<input type="reset" class="reset" value="{reset}"/></p></fieldset></form>';
