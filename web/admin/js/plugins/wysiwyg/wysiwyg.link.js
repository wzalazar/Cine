	...
	$.wysiwyg.controls.link = {
		init: function (Wysiwyg) {
			...
			formLinkHtml = '<form class="wysiwyg"><fieldset>' +
				'<p><label>{url}: </label> <input type="text" name="linkhref" value=""/></p>' +
				'<p><label>{title}: </label> <input type="text" name="linktitle" value=""/></p>' +
				'<label>{target}: </label> <input type="text" name="linktarget" value=""/></p>' +
